...
class fileNew extends React.Component {
    render() {
        ...
        return (
            ...
            <p>Upload File: <input className="formField" name="name" type="text" onInvalid="alert('Please fill out this field.');" required /></p>
            <p>Pet ID: <input className="formField" name="pet_id" type="text" onInvalid="alert('Please fill out this field.');" required /></p>
